...
func (t *Tree) extract(q *d, i int) { // (r MetricWithCount) {
	t.ver++
...
func (t *Tree) First() (k []byte, v MetricWithCount) {
	if q := t.first; q != nil {
		q := &q.d[0]
		k, v = q.k, q.v
	}
...
// returns (nil, false).
func (t *Tree) Get(k []byte) (v MetricWithCount, ok bool) {
	q := t.r
	if q == nil {
		return
	}
...
func (t *Tree) insert(q *d, i int, k []byte, v MetricWithCount) *d {
	t.ver++
	c := q.c
	if i < c {
...
func (t *Tree) Last() (k []byte, v MetricWithCount) {
	if q := t.last; q != nil {
		q := &q.d[q.c-1]
		k, v = q.k, q.v
	}
...
func (t *Tree) overflow(p *x, q *d, pi, i int, k []byte, v MetricWithCount) {
	t.ver++
	l, r := p.siblings(pi)
...
func (t *Tree) Set(k []byte, v MetricWithCount) {
	pi := -1
	var p *x
	q := t.r
	if q != nil {
...
func (t *Tree) split(p *x, q *d, pi, i int, k []byte, v MetricWithCount) {
	t.ver++
	r := &d{}
	if q.n != nil {
		r.n = q.n
...
// io.EOF is returned.
func (e *Enumerator) Next() (k []byte, v MetricWithCount, err error) {
...
// == io.EOF is returned.
func (e *Enumerator) Prev() (k []byte, v MetricWithCount, err error) {
	if err = e.err; err != nil {
		return
	}
